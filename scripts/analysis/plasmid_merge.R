...
# for all plasmid fragments in a genome, find a best parent plasmid
# if two or more plasmid fragments in genome can be linked to a single larger
# plasmid, use this to merge plasmid
