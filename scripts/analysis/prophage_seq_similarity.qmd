---
title: "Prophage clustering using ANI and MASH"
...
This script process ANI and MASH output for prophages and store the distance
matrices for consolidated prophages for future use.
...
phages <- suppressMessages(
  ...
  dplyr::filter(filtered == 0, nFragments == 1) %>% 
  dplyr::select(
