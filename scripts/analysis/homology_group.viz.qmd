...
analysisName <- "top_prophage_clusters"

setIds <- c(
  # "g_3.vir_4", "g_189.vir_2", "g_399.vir_2", "g_189.vir_1", "g_172.vir_2"
  # "g_438.vir_2"
  "g_438.vir_2", "g_404.vir_1", "g_302.vir_2", "g_273.vir_3", "g_311.vir_3", "g_389.vir_4", "g_239.vir_3", "g_364.vir_3", "g_142.vir_2", "g_119.vir_2", "g_274.vir_6", "g_419.vir_2", "g_10.vir_3", "g_200.vir_2"
)
...
for (st in hgSetFiles) {
  df <- suppressMessages(readr::read_tsv(st)) %>%
    ...
    dplyr::select(id = prophage_id, hgs, setSource)
...
for (id in names(hgL)) {
  ...
  hgMat <- homology_groups_mat(
    pandb = panOrgDb, type = "pav", groups = hgL[[id]]$hgs
  )
...
pdf(file = paste(outPrefix, ".hgs.pdf", sep = ""), width = 16, height = 8)
ComplexHeatmap::draw(
  object = htList,
