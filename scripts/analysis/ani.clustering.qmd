...
Average nucleotide identity (ANI) between all genomes calculated by `fast-ani` 
tool are processed and visualized in this script.
...
rootedNj <- ape::root(treeNj, outgroup = sampleInfoList[[outGroup]]$Genome)
