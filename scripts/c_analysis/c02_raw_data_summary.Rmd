...
## Row2 {data-height="400"}

### NCBI assembly taxanomy check status: count

```{r, txQc, fig.height=8, fig.width=3}
...
### NCBI assembly taxanomy check status: sanky

```{r}

freqData <- dplyr::select(
  metadata, AssemblyAccession, ExclFromRefSeq, Anomalous, replaced,
